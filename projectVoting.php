                ...
                <div class="d-flex flex-row flex-wrap" style=" width: 100%;">
                    <?php foreach($userProjects as $userProject) : ?>
                            <div class="col-sm-4 my-3">
                                ...
                                <?php if (Items::getProjectWinner($_GET['projectId'])['user_id'] == $userProject['user_id']) : ?>
                                ...
                                <?php endif; ?>
                                    ...
                                    <?php if (Items::getProjectWinner($_GET['projectId'])['user_id'] == $userProject['user_id']) : ?>
                                    <li class="card-text list-group-item d-flex justify-content-between align-items-center" style="border-radius: 0; background-color: #3647FC"> <span><?php echo Votes::getProjectVotes($userProject['user_id'], $userProject['project_id'])?> votes</span> <span>by <strong><?php echo Burger::getUserById($userProject['user_id'])['username'] ?></strong></span> 
                                        <?php if ($userType == 0) : ?>
